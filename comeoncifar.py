...
class direct_dataset(Dataset):
    def __init__(self, logger, dataset):
        ...
        for i in range(1, 5):
            # data!
            path = "/luoyan/IntraQ-master/data_generate/cifarresult/my_resnet20_cifar100refined_gaussian" + str(i) + ".pickle"
            ...
            # label!
            path = "/luoyan/IntraQ-master/data_generate/cifarresult/my_resnet20_cifar100labels_list" + str(i) + ".pickle"
            self.logger.info(path)
            with open(path, "rb") as fp:  # Pickling
...
class ExperimentDesign:
    def __init__(self, generator=None, options=None, conf_path=None, args=None):
        ...
        shutil.copyfile(conf_path, os.path.join(self.settings.save_path, 'cifar100_resnet20.hocon'))
        shutil.copyfile('/luoyan/IntraQ-master/comeoncifar.py', os.path.join(self.settings.save_path, 'comeoncifar.py'))
...
def main():
    ...
    parser.add_argument('--conf_path', type=str, metavar='conf_path', default='/luoyan/IntraQ-master/cifar100_resnet20.hocon',
                        help='cifar10_resnet20.hocon, cifar100_resnet20.hocon')
    parser.add_argument('--id', type=int, metavar='experiment_id', default='01',
                        help='Experiment ID')
    parser.add_argument('--model_name', type=str, metavar='model_name', default='resnet20_cifar100',
                        help='resnet20_cifar10, resnet20_cifar100')
