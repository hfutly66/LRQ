...
if __name__ == '__main__':
    ...
    if args.model == 'regnetx_600m':
        ...
        state_dict = torch.load('/luoyan/IntraQ-master/pytorchcvaa/pretrained/resnet18-0896-77a56f15.pth')      #resnet18-0982-0126861b.pth, 66.364   resnet18-0896-77a56f15.pth,  
